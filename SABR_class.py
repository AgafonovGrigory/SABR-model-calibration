...
class SABR:
    ...
    def fit_iv(self,
        ...
        """
        Method calibrate pararmeters of the SABR model to market implied volatility and changes
        self.sabr_params on calibrated
    ...
    def predict_call_price(self, K: np.ndarray,
                           ...
                           T: np.ndarray) -> np.ndarray:
        """
        Method returns call option price for given parameters K, F, T 
    ...
    def predict_put_price(self, K: np.ndarray,
                           ...
                           T: np.ndarray) -> np.ndarray:
        """
        Method returns put option price for given parameters K, F, T 
